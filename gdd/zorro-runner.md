...
- **Emoji:** 🦊
- **Status:** beta — built and playable, listed under the index's "Beta
  games" button (`"beta": true` in `games.json`) pending further polish
  before it's ready for the main list.
